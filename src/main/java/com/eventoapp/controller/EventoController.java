...
public class EventoController {
	...
	public String form(@Valid Evento evento, BindingResult result, RedirectAttributes attribute) {
		if (result.hasErrors()) {
			attribute.addFlashAttribute("mensagem", "Todos os campos devem ser preenchidos");
			return "redirect:/cadastrarEvento";
		}
		er.save(evento);
		attribute.addFlashAttribute("mensagem", "Evento adicionado com sucesso!");
	...
	public String detalhesEventoPost(@PathVariable("codigo") long codigo, @Valid Convidado convidado,
		...
		cr.save(convidado);
		attribute.addFlashAttribute("mensagem", "Convidado adicionado com sucesso!");
		return "redirect:/{codigo}";
	}
